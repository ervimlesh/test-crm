...
const CtmAdminTodayBooking = () => {
  ...
  console.log("filteredBookings is", filteredBookings);
      ...
      <main class="crm_all_body d-flex">
        ...
        <div className="crm_right relative">
          <div className="header_crm flex_props justify-content-between">
            <p className="crm_title">All Today BIDS ctm admin today booking</p>
          </div>
...
export default CtmAdminTodayBooking;
