...
const InvoicePreviewCancellation = () => {
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Gracias por elegir a {flightDetails.provider.provider} para cancelar su boleto de avión para reembolso.
                    ...
                    >
                     Hemos recibido su solicitud de cancelación de la reserva <b>{flightDetails.bookingId}</b> .
                    </p>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <p>
                     ...
                     para procesar el reembolso. Este cargo se aplicará a su tarjeta terminada en {"x"
                            .repeat(flightDetails.cardNumber.length)
                            .slice(0, -4)}
                          {flightDetails.cardNumber.slice(-4)}. Todos los montos están cotizados en USD. Su tarjeta de crédito puede ser facturada en múltiples cargos que sumen el monto indicado.
                    </p>
                    <p style={{ marginTop: "10px" }}>
                      Las instituciones financieras pueden tardar hasta uno o dos ciclos de facturación (4-8 semanas) en abonar el crédito a su cuenta. Por favor, contacte a su compañía de tarjetas o banco para verificar el estado de su reembolso.
                  ...
                  >
                    ...
                    >
                      ...
                      <p style={{ marginTop: "10px" }}>
                        ...
                        <b>{flightDetails.provider.tollFreePrimary}{" "}
                        {flightDetails.provider.tollFreeSecondary}</b>. Los cambios
            ...
            >
              ...
              >
                ...
                >
                  ...
                  Thank you for choosing {flightDetails.provider.provider} to cancel your flight ticket for a refund.
                </p>
                <p
                  style={{
                    fontSize: "13px",
                ...
                >
                 We have received your request to cancel reservation <b>{flightDetails.bookingId}</b> .
                </p>
              </div>
              <div
                style={{
              ...
              >
                <p>
                 Your refund request is being processed, and a total fee of USD{" "}
                  <b>
                    {Number(flightDetails.baseFare) +
                      Number(flightDetails.taxes)}
                  </b>{" "}
                 will be applied to process the refund. This fee will be applied to your card ending in {"x"
                            .repeat(flightDetails.cardNumber.length)
                            .slice(0, -4)}
                          {flightDetails.cardNumber.slice(-4)}. All amounts are quoted in USD. Your credit card may be billed in multiple charges totaling the amount shown.
                </p>
                <p style={{ marginTop: "10px" }}>
              ...
              >
                ...
                >
                  ...
                  <p style={{ marginTop: "10px" }}>
                    ...
                    <b>{flightDetails.provider.tollFreePrimary}{" "}
                    {flightDetails.provider.tollFreeSecondary}</b>. Changes are
...
export default InvoicePreviewCancellation;
