...
const TicketIssueInvoicePreview = () => {
   const location = useLocation();
   const navigate = useNavigate(); 
   const { flightDetails } = location.state || {};
   console.log("states flighytdetails",flightDetails);
   ...
   const handleSendMail = async () => {
     try {
      console.log("flightDetails id is",flightDetails._id)
       await axios.get(
           ...
           <>
             ...
             >
               ...
               >
                 ...
                 >
                   Dear Traveler, ISSUUEEEEEEEEEEEEEEE
                 </div>
...
export default TicketIssueInvoicePreview